  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] px-3 sm:px-4">
        ...
        <button
          onClick={() => navigate(-1)}
          className="px-2 py-1 sm:px-3 sm:py-1.5 bg-gradient-to-r from-cyan-400 to-cyan-600 text-white rounded-lg hover:from-cyan-500 hover:to-cyan-700 text-sm transition-all animate-cyan-wave"
        >
          Go Back
        </button>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20 pt-2 sm:pt-4">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 pb-20">
        ...
        <div className="flex justify-between items-center gap-1 mb-2 sm:mb-5">
          ...
          {/* User gems badge */}
          <div className="bg-cyan-100 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300 px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full flex items-center shadow text-xs sm:text-sm">
                      ...
                      {categoryItems.map(item => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={`${item.category === 'badge' ? 'h-16 sm:h-24 md:h-32' : 'h-24 sm:h-48 md:h-56'} bg-gray-100 dark:bg-gray-700 flex items-center justify-center p-0.5`}>
                              {item.imageUrl ? (
                                <img
                                  src={item.imageUrl}
                                  alt={item.name}
                                ...
                                <div className="w-10 h-10 sm:w-20 sm:h-20 rounded-full bg-cyan-100 dark:bg-cyan-900/30 flex items-center justify-center text-xl sm:text-4xl">
                              ...
                              <button
                                ...
                                className={`px-1 py-0.5 sm:px-2 sm:py-1 text-[9px] sm:text-xs font-medium rounded-md ${isOwned
                                  ...
                                  : (user?.gems || 0) < item.price
                                    ...
                                    : "bg-gradient-to-r from-cyan-400 to-cyan-600 text-white hover:from-cyan-500 hover:to-cyan-700 transition-all shadow-sm animate-cyan-wave"
                                  }`}
                              >
            ...
            <div>
              ...
              {inventory.length === 0 ? (
                <div className="bg-blue-50 dark:bg-blue-800/20 rounded-md p-2 sm:p-3 text-center">
                  <p className="text-cyan-700 dark:text-cyan-300 text-xs mb-1.5 sm:mb-3">
                    You don't have any items yet.
                  </p>
                  <button
                    onClick={() => setActiveTab("shop")}
                    className="px-1.5 py-0.5 sm:px-3 sm:py-1 bg-gradient-to-r from-cyan-400 to-cyan-600 text-white rounded-md hover:from-cyan-500 hover:to-cyan-700 transition-all shadow-sm text-[10px] sm:text-sm animate-cyan-wave"
                  >
                    Go to Shop
                  </button>
                </div>
                      ...
                      <div className={`grid gap-3 sm:gap-4 ${category === 'background'
                        ...
                        {items.map(item => (
                          ...
                          >
                            ...
                            {/* Item image - shorter height on mobile */}
                            <div className={`${item.details.category === 'badge' ? 'h-16 sm:h-24 md:h-32' : 'h-28 sm:h-56 md:h-64'} bg-gray-100 dark:bg-gray-700 rounded flex items-center justify-center mb-0.5 sm:mb-2 p-0.5`}>
