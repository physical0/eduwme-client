...
const Settings = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20 pt-2 sm:pt-4">
      <div className="max-w-full sm:max-w-xl md:max-w-2xl mx-auto px-2 sm:px-3 md:px-4 py-3 sm:py-4 md:py-6 pb-20 sm:pb-24 md:pb-16 transition-colors duration-300">
